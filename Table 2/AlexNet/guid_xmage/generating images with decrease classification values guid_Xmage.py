"""
The main function of this code file is to generate evaluation images for decreasing image classification values based on the "guid_Xmage" method.
Step 1, you need to set "actual_image_folder_absolute_path" to the absolute path of the folder storing the original images.
Step 2, you need to set "tamper_image_folder_absolute_path" to the absolute path of the folder storing the final generated tampered images.
Step 3, you need to set "pixel_weight_matrix_R_path", "pixel_weight_matrix_G_path", and "pixel_weight_matrix_B_path" to the absolute paths of the folders storing the pixel weight matrices for the original images' RGB channels.
Finally, executing this code file will generate evaluation images based on the "guid_Xmage" method for decreasing image classification values.
"""
