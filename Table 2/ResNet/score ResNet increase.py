"""
The main function of this code file is to evaluate the scores of experimental images generated based on ResNet that aim to increase classification values.
