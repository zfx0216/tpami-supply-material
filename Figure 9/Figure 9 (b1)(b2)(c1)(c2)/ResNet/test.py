"""
The main function of this code file is to use the trained ResNet model to calculate the classification accuracy of a certain test set.
...
model = models.resnet18(num_classes=3).to(device)
# Absolute path to import weight file
model.load_state_dict(torch.load("..."))  # loading weights file
model.to(device)
