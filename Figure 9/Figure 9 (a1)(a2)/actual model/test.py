"""
The main function of this code file is to calculate the accuracy of a trained AlexNet on the test set.
Firstly, you need to set the parameter "image_path" to the absolute path of the test set folder.
Secondly, you need to import the trained weight file through "model. load_stateDict"
"""
