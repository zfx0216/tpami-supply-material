"""
The main function of this code file is to select the images that are correctly classified by AlexNet.
Firstly, you need to set the parameter "folder_path" to the absolute path of the folder where the original images are stored.
...
Fourthly, you need to set the parameter "dst'folder_path" to the absolute path of the folder where the correctly classified images are stored
"""
...
def main():
    ...
    for file_name in file_list:
        ...
        print(
            "File: {}   Top 1: index: {}  class: {:10}    class_value: {:.10f}  probability: {:.10f}".format(file_name,
                                                                                                             class_index,
                                                                                                             class_name,
                                                                                                             class_value,
                                                                                                             class_prob))
        ...
        if class_index == 0:
            num = num + 1
            # The absolute path to the folder where correctly judged images are stored
            dst_folder_path = r"..."
