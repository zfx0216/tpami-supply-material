"""
The main function of this code file is to use C&W to attack AlexNet and generate a series of attack samples.
Firstly, you need to set the "weights path" parameter to the absolute path of the AlexNet model's weight file.
Secondly, you need to set the "folder_path" parameter to the absolute path of the folder where the original image is stored.
Thirdly, you need to set the "save_path_for-adversarial_samples" parameter to the absolute path of the folder where the generated attack samples are saved
"""
